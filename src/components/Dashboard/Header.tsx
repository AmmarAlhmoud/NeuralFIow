...
const Header: React.FC<HeaderProps> = ({ currentPage }) => {
  ...
  return (
    <header className="sticky top-3 mx-6 mb-8 xl:mb-6 z-20">
      <div className="glassmorphic rounded-2xl p-4 pb-0 xl:pb-4 h-auto xl:h-full bg-white/30 dark:bg-gray-900/30 border border-white/10 dark:border-gray-700/30">
        <div className="w-full flex flex-row xl:flex-row items-center justify-between px-4 space-y-6 xl:space-y-0">
          <section className="flex-1 flex flex-col justify-center items-center space-y-4 xl:flex-row xl:items-center xl:space-y-0 xl:space-x-6">
